...
<head>
	...
	<title><spring:message code="others.PersonEdition"/></title>
</head>
...
<div class="main">
	...
	<div class="container">
		<h1><spring:message code="others.ProfileEdition"/></h1>
		...
		<form:form method="POST" modelAttribute="person">
			...
			<div class="form-group">
				<label for="firstName"><spring:message code="others.Prenom"/>:</label>
				<form:input class="form-control" path="firstName" />
				<form:errors path="firstName" cssClass="alert alert-warning"
					element="div" />
			</div>
			<div class="form-group">
				<label for="lastName"><spring:message code="others.NomDeFamille"/>:</label>
				<form:input class="form-control" path="lastName" />
				<form:errors path="lastName" cssClass="alert alert-warning"
					element="div" />
			</div>
			<div class="form-group">
				<label for="website"><spring:message code="others.SiteWeb"/>:</label>
				<form:input class="form-control" path="website" />
				<form:errors path="website" cssClass="alert alert-warning"
					element="div" />
			</div>
			<div class="form-group">
				<label for="birthDay"><spring:message code="others.DateNaissance"/>:</label>
			...
			<div class="form-group">
				<label for=group><spring:message code="others.Groupe"/>:</label>
